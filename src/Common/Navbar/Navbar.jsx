    ...
    <div className="navbar fixed z-10 bg-[#00113B] bg-opacity-70 text-white max-w-[1920px]">
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <ul
            tabIndex={0}
            className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow-gray-100 shadow-inner bg-[#00113B] rounded-box w-52"
          >
            {navlinks}
          </ul>
        </div>
            ...
            <div className="dropdown dropdown-end z-[50]">
              ...
              >
                ...
                <Link
                  ...
                  className="btn uppercase bg-[#4C40F7] text-white hover:text-[#FC0] hover:bg-[#4C40F7] text-xl font-bold"
                >
