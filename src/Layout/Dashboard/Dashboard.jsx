  ...
  return (
    <div className="drawer lg:drawer-open">
      ...
      <div className="drawer-content">
        <label
          htmlFor="my-drawer-2"
          className="btn bg-transparent border-0 text-2xl font-extrabold text-white drawer-button lg:hidden"
        >
          <TiThMenu />
        </label>
        <Outlet></Outlet>
      ...
      <div className="drawer-side">
        ...
        <ul className="menu p-4 w-80 min-h-full bg-[#0f2a6df2] text-white shadow-inner shadow-[#7872d6]">
          <h1 className="uppercase text-2xl font-bold py-3 text-[#FC0]">
            dream-prime-estates
          </h1>
          <hr className="mb-8" />
          {isAdmin ? (
